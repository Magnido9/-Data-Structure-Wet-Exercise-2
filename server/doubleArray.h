...
public:
 DoubleArray(const int curse_id ,const int num_of_classes, int course_number);
 ~DoubleArray();
...
DoubleArray::DoubleArray(const int course_id,const int num_of_classes,int course):unwatched_classes(num_of_classes),start_list(nullptr),end_list(nullptr),course_number(course)
{
...
int DoubleArray::getCourseNumber()
{
